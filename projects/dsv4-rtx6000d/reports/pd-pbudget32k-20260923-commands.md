...
```bash
docker run -v /home/enhui/llm-serving-benchmarks/experiments/dsv4-pd-pbudget32k-20260923/hooks/request_records.py:/request_records.py:ro --pull never --name pb32-20260923-01-client-c128-measurement-01 --label io.serving-bench.run=pb32-20260923-01 --network host -v /data/models/DeepSeek-V4-Flash-0731-NVFP4:/model:ro -v /home/enhui/llm-serving-benchmarks/experiments/dsv4-pd-pbudget32k-20260923/results/PB32-01/benchmark/c128/measurement-01:/results:rw -v /home/enhui/llm-serving-benchmarks/src/serving_bench/clients/jsonl_dataset.py:/jsonl_dataset.py:ro -v /home/enhui/llm-serving-benchmarks/experiments/dsv4-pd-pbudget32k-20260923/data/govreport-16k-prefix-1024-v2.jsonl:/dataset.jsonl:ro --cpuset-cpus 20-23 --cpuset-mems 1 -e HF_HUB_OFFLINE=1 -e TRANSFORMERS_OFFLINE=1 --entrypoint python3 sha256:c2914767605584b6d8f45686b82de173ecc99e781897aa3d0a66dacd72c51ae1 -c 'import runpy; runpy.run_path('"'"'/request_records.py'"'"')
import re, json
from pathlib import Path
def id_set(value: str) -> set[int]:
    """Parse the Linux CPU/node list syntax used by Docker and /proc."""
...
通用 workload 仍按默认三轮通过配置校验；本次实验脚本按用户明确授权，在解析后的 workload 中覆盖 `repetitions=1,max_rounds=1,budget_s=1800`，并保存实际 workload/protocol。没有修改公共校验或验收规则，也没有把单轮称为稳定性能。实际请求预算为24条功能、256条预热、512条正式，重试0次。
