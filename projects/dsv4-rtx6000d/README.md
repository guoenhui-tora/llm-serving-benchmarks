...
- [x] **47**：测试已收尾，完整正式测量24次。TP4×DP2 EP off的C32部分结果及两次带首次使用事件的C64诊断值已单列；后者未通过gate，不入正式CSV或排名，本批无TileLang实际编译记录。见[本节点报告](reports/node8-node47.md)、[逐次CSV](data/node8-node47.csv)。
