...
**TP4扩展的quick证据已覆盖C64多服务：** 8K/16K三副本普通、1P2D、2P1D，以及16K四副本普通，共7组、21轮正式测量均0已知事件（每组先完整N256 HTTP预热）。部分普通组HTTP预热仍出现24/64条top-k索引事件，所以不能省去该步骤。这里只确认已测配置；2P2D、4P2D的结果随[配比报告](reports/pd-ratios-c64-20260921.md)更新。
