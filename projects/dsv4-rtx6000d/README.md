...
[C64配比研究](reports/pd-ratios-c64-20260921.md)已开始：16K普通三副本（3服务×4GPU=12GPU）1157.11±0.46 tok/s、三轮0事件；同资源2P1D为1190.46±0.76（+2.88%，三轮0事件），TTFT增加15.68%、TPOT降低10.29%；反向1P2D正在执行。
