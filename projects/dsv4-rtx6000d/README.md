...
- [x] **47**：正式整机样本27次（完整C32/C64配置24次＋新增TP4×DP2 EP off独立C64三次）。新C64测量期均无已知JIT事件，878.47 ± 26.48 tok/s、CV 3.01%，保留波动限制；不与旧C32拼接。见[本节点报告](reports/node8-node47.md)、[逐次CSV](data/node8-node47.csv)。
