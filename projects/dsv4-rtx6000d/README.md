...
今晚的有界执行队列见[2026-09-22夜间PD计划](reports/pd-night-20260922-plan.md)。首个普通三服务候选的实际启动记录见[计划执行记录](reports/pd-night-20260922-execution.md)：47节点在 `16384 vs 160` 的DP profiling断言处未通过，尚未产生新性能数据；恢复实验前先做单服务启动诊断，不把失败候选或旧8K结果混入12卡16K配对。
