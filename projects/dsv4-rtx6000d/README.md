...
[C64配比研究](reports/pd-ratios-c64-20260921.md)完成12组（每轮前256条、输出1024、总C64）。同12卡16K普通/1P2D/2P1D为1157.11/664.33/1190.46 tok/s，2P1D高2.88%但TTFT高15.68%；8K为1650.78/1243.88/1346.24，两种PD均低于普通。同16卡2P2D在16K低15.56%、8K低13.73%（后者有漂移）。同24卡16K普通六副本1876.76±0.27、4P2D1774.22±7.63，PD低5.46%；平均TTFT低21.31%，P95 TTFT却高36.67%，普通还含正式JIT事件，不称稳态优势。

**夜间研究已收尾：24个完整性能单元、72轮正式测量，另保留3次失败尝试，共18,734个外部请求。** 10点检查点已归档，按授权完成必要配对至11:20；四节点本轮容器均已清理。JIT、数据、失败、跳过与后续建议见[夜间总览](reports/pd-overnight-results-20260921.md)。
...
[定向预热与同八卡正式对照](reports/pd-targeted-warmup-20260921.md)已完成：修复固定镜像NVIDIA mHC启动预热入口遗漏后，普通双TP4 **1029.25±1.58**、1P1D各TP4 **913.91±1.66 output tok/s**，各三轮clean。PD低11.21%，平均TTFT/TPOT也未改善；真实KV传输成立。结论限定GovReport总C32、前128条、DSpark off；后续P预算、16K、拓扑/DSpark及配比对照已完成，见[夜间总览](reports/pd-overnight-results-20260921.md)。预热模块见[适配说明](patches/mhc-startup-warmup/README.md)。
